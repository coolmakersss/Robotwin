...
if [ ${mode} = "cts-10d-mode-ratio" ]; then
python scripts/process_data_cts_10d_action_mode_ratio.py $task_name $setting $expert_data_num
fi
...
# bash process_data_pi0.sh lift_pot aloha-agilex_clean_50 50 cts-10d-mode-ratio
