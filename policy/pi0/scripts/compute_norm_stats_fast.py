...
def select_batch_size(num_frames: int, max_batch_size: int = 8) -> int:
    for batch_size in range(min(max_batch_size, num_frames), 0, -1):
...
def main(config_name: str, max_frames: int | None = None):
    ...
    batch_size = select_batch_size(num_frames)
    batch_size = 8
