...
class DataConfig:
    ...
    # Optional target keys that are used for auxiliary training losses, but are not part of the policy input.
    aux_target_keys: Sequence[str] = ()
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_chunk_delta_position_10d_action_grab_roller-aloha-agilex_clean_50",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            ############################# for 10d action: 3d pos + 6d rot + 1d gripper per arm #############
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/grab_roller-aloha-agilex_clean_50-50-10d_action",  # your datasets repo_id
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_chunk_delta_position_10d_action_grab_roller-arx-x5_clean_50",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            ############################# for 10d action: 3d pos + 6d rot + 1d gripper per arm #############
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/grab_roller-arx-x5_clean_50-50-10d_action",  # your datasets repo_id
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_chunk_delta_position_10d_action_lift_pot-aloha-agilex_clean_50",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            ############################# for 10d action: 3d pos + 6d rot + 1d gripper per arm #############
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/lift_pot-aloha-agilex_clean_50-50-10d_action",  # your datasets repo_id
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_chunk_delta_position_10d_action_lift_pot-arx-x5_clean_50",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            ############################# for 10d action: 3d pos + 6d rot + 1d gripper per arm #############
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/lift_pot-arx-x5_clean_50-50-10d_action",  # your datasets repo_id
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_50_tasks_clean_cts_10d_action",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_50_tasks_clean_cts_10d_action_mode_ratio_aux",
        model=pi0.Pi0Config(predict_mode_ratio=True),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi_clean_50-cts-10d_action-mode-ratio",
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
            ...
            base_config=DataConfig(
                local_files_only=True,
                prompt_from_task=True,
                aux_target_keys=("mode", "ratio"),
            ),
        ),
        freeze_filter=pi0.Pi0Config(predict_mode_ratio=True).get_freeze_filter(),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "s3://openpi-assets/checkpoints/pi0_base/params"
        ),
        batch_size=128,
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_50_tasks_clean_cts_10d_action_mode_ratio_aux_token",
        model=pi0.Pi0Config(predict_mode_ratio=True, mode_ratio_use_aux_token=True),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi_clean_50-cts-10d_action-mode-ratio",
            raw_action_dim=20,
            adapt_to_pi=False,
        ...
        freeze_filter=pi0.Pi0Config(predict_mode_ratio=True, mode_ratio_use_aux_token=True).get_freeze_filter(),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "s3://openpi-assets/checkpoints/pi0_base/params"
        ),
        batch_size=128,
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_full_50_tasks_clean_cts_10d_action_mode_ratio_prefix_aux_token",
        model=pi0.Pi0Config(predict_mode_ratio=True, mode_ratio_use_prefix_aux_token=True),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi_clean_50-cts-10d_action-mode-ratio",
            raw_action_dim=20,
            adapt_to_pi=False,
        ...
        freeze_filter=pi0.Pi0Config(predict_mode_ratio=True, mode_ratio_use_prefix_aux_token=True).get_freeze_filter(),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "s3://openpi-assets/checkpoints/pi0_base/params"
        ),
        batch_size=128,
    ...
    TrainConfig(
        name="pi0_base_aloha_realworld_sweep_table_10d_action",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/sweep_table-realworld-10d_action",
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_realworld_multi_10d_action",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi-realworld-10d_action",
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_realworld_multi_cts_10d_action",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi-realworld-cts-10d_action",
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_realworld_multi_cts_10d_action_mode_ratio_prefix_aux_token",
        model=pi0.Pi0Config(predict_mode_ratio=True, mode_ratio_use_prefix_aux_token=True),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi-realworld-cts-10d_action-mode-ratio",
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
    ...
    TrainConfig(
        name="pi0_base_aloha_robomimic_transport_10d_action",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="/mnt/afs/huangdi/xiangenda/.cache/huggingface/lerobot/multi-robomimic-transport-10d_action",
            raw_action_dim=20,
            adapt_to_pi=False,
            use_delta_joint_actions=True,
            delta_action_mask=_transforms.make_bool_mask(3, -7, 3, -7),
